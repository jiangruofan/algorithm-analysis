...
类似背包问题 dp[i][j][k]表示前i层使用j个o和k个🌟所能构成的方案数 对于第前i层 如果使用j个o 那么ke y
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTU3NDE0MTk1LC05MTAzNTI4ODgsNjM2MT
YzNDA3LC0xNDYyMzM0OTQ0LC05NDg4NDUyODcsMjA4NjUzMDEy
NywzNDE3Mzk0NzFdfQ==
-->