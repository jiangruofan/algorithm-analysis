...
**Q1 . Process scheduler**  
There are n processes where the ith process starts its execution at start[i] and ends at end[i],  
both inclusive. Find the minimum number of cores required to execute the process.
...
---
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjI2NDM2ODIsLTI1NTczMzkwNSwxMT
