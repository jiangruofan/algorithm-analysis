...
然后就是dfs遍历
    ...
    def dfs(node, fa, sum1, hissum1):
	    ...
	    hisfirst, hissecond = hissum1, -float('inf')
	    for child in edges[node]:
		    if child == fa:
			    continue
			total += max(0, nums[child][1])
			if nums[child][2] > hisfitst:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTkxMDcwMTEzLC0xNTQwNzgyNTIzLC0zMT
c3OTE3MDMsMTA2ODcwOTYzMiwxOTQ2MDI1MzA0LC00NjAyOTk1
MzAsMTMyODczNzUwMSwtMTMxNzk5MzgyOCw4MzQ0Mzk3NzcsLT
k0MzUyNTcsOTYwNjY4ODQxLC0xNTMwNzc1MDQwLC0xMzMzNTUz
MjQsMTI2MDA2NDk3Myw0NTI4NTU0ODAsLTE2NTkyODgzNjYsLT
g3NDc1MDI0NSwxMDcxNTc4ODQ4LDE1ODk2NDcwNDEsMTk1MDMy
MDE4XX0=
-->