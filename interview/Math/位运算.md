...
对于 b 如果ith为1 那么 a 和 b 对应的ith一定为1和0 加起来一定是1 所以这个时候看a 如果a的ith也是1 那么最好 如果是0 那么a和b的ith的前一位就是1和1 这个时候ith的hou
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTQyNjIzNDEsMTczMDg0Njc3MywxMD
U4NzcyMzYsLTQ5MzYwMTI2NSwtMjA3MjgzNDQyMiwtOTAwMTQ3
MjIyLDEyNDM3Nzk5NjNdfQ==
-->