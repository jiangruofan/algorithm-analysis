...
[Online Assessment Question](https://leetcode.com/discuss/interview-question/2958748/Online-Assessment-Question)

Hi , I need your help in one question  
You are given an array A of size N

The score of subsequence B of array A is defined as Score(B) = maximum(B)_minimum(B). This means that  
if A={1,2,3,4)then B = {1,3,4} is a subsequence and its score will be 1_4=4

find the total sum of the score of the score of all non empty subsequence of A. Since the answer can be very large return it modulo 998244353
...
1 2 3  
Sample Output = 28  
Here all Sequence are {1} {2} {3} {1,2} {2,3} {1,3} {1,2,3}  
score will be 1_1 + 2_2 + 3_3 + 1_2 + 2_3 + 1_3 + 1*3  
= 28

3  
1 2 1  
Sample Output = 13  
Here all Sequence are {1} {1} {2} {1,2} {2,1} {1,1} {1,2,1}  
total score will be 1 + 1+ 4 + 2+ 2 + 1+ 2 = 13
...
def scoreSums(a):
    ...
    for i in range(len(a) - 1, -1, -1):
        # this element and itself
        ret = (ret + a[i] * a[i]) % mod 
        # this element and all to its right
        ret = (ret + a[i] * pre) % mod 

        # now add this element to our prefix:
        #  - we get an extra element between all mins to the left and their maxes on the right
        pre = (pre * 2) % mod 
        #  - we get this element as another max 
        pre = (pre + a[i]) % mod 
...
[Deloitte | OA | Points Satisfying Given Conditions](https://leetcode.com/discuss/interview-question/2988404/Deloitte-or-OA-or-Points-Satisfying-Given-Conditions)

#### Points Satisfying Given Conditions

Given the equation  _`f(x, y) = x^2 + 5xy + 3y^2`_  and an integer  `N`, count the number of points  `(x, y)`  which satisfies the following conditions:
...
![image](https://assets.leetcode.com/users/images/49cd2203-e9cd-4550-a258-e97603b8f646_1673170246.1498365.png)
![image](https://assets.leetcode.com/users/images/810c3efd-2ccd-42f0-9784-a0b558482d04_1673170262.9944017.png)

先排序 然后左右两边 要么左边一个数字变大并且右边一个数字变小
要么左边两个数字变大 或者 you bian
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjEwNjk5NjkwLDEwMTY4MTQ1NjUsLTE1ND
E5ODU3MSwxMjgyOTE2Nzc1LDExOTczODYzMDcsLTE4MzgzOTkz
OTksLTczNjg4MjA4OCwxNTQwNjc3NjMsMTU1MjMwOTA4NiwtMT
E2MzA2ODkyMSwxOTc3NTkyODM5LC0xMjU1MzYyMzg5LDE1NDQ1
Njg3ODYsMTkwMDY3OTcxNywtMTAwNTYwNDY2MSw0NDE4OTYwMj
MsMjQ3NzczNzYzLC0xMzU0MTU5NzI5LDE5MzA4Nzk3OTEsLTEx
OTU1ODYyMzhdfQ==
-->