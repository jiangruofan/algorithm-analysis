...
给定一个size k 数字最多32位 计算出每一位有哪些数字 给定一个x从高位到低位 如果当前位是0 那么看是否有y个数字满足 如果有的话 那么答案一定是当前符合条件的数字中取y个 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMTUzMjk5NzAsLTE3NTM3ODI3ODMsLT
cwNDQ4NzExNCwyMDE0OTA3OTgxLDE4MDcwNzk5NzYsLTQ2MzIy
MTE5NiwyMDY4MjM2MjgsNDc3NTIzODM3LC0yMzk2NDk2MjIsLT
E1NTE2NDU4OTIsODI3MjcyNTddfQ==
-->