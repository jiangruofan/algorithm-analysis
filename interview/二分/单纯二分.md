...
假设m大于n 求m和n的最大公因数为x 最小公倍数为y 那么mn肯定是y的倍数 对于m的倍数一直到y 对n取模为 x 2x 3x ...... 0  所以就是一个循环 间隔就是x 
m=18 n=12  0:0; 18:6; 36:0  6 0 6 0 .... 6 
只需要对
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4NzU4NjYwMSwtMTI2NDc5NTU1MywtMj
A1NDM3NzM1NSwtNDk0MjM1MzAyLDIwMjAxNzg2NzksMTAzMTkx
NzYwNSwtMTQ2Njc4NDk3Nl19
-->